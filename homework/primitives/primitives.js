...
var Primitives = {
    ...
    // if dashed == true draw a dashed line.
    
    // JD: ^We have a misunderstanding here: the dash parameter is
    //     supposed to be an *integer*, not a boolean.  Re-read the
    //     assignment instructions to see this.
    lineBresenham: function (context, x1, y1, x2, y2, color, dashed) {
        var x = x1,
            y = y1,
            dx = x2 - x1,
            dy = y1 - y2,
    ...
    plotCirclePoints: function (context, xc, yc, x, y, color) {
        color = color || [0, 0, 0];
        // JD: Whoa!  I can safely say, not what we are looking for.
        //     I appreciate how much code this has taken, but really,
        //     I'd say about a couple of lines in, red flags should
        //     have been raised and you should have checked in with
        //     me.  Rest assured, I would *never* ask you for something
        //     whose code would end up being this complicated.  The
        //     moment you find yourself heading this way, you should
        //     check in with me.
        for (var i = 0; i <= (2*Math.PI*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2)))); i++) {
            this.setPixel(context, xc + (x-(Math.cos((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), yc + (y-(Math.sin((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), color[0], color[1], color[2]);
            this.setPixel(context, xc + (x-(Math.cos((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), yc - (y-(Math.sin((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), color[0], color[1], color[2]);
            this.setPixel(context, xc + (y-(Math.sin((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), yc + (x-(Math.cos((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), color[0], color[1], color[2]);
            this.setPixel(context, xc + (y-(Math.sin((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), yc - (x-(Math.cos((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), color[0], color[1], color[2]);
            this.setPixel(context, xc - (x-(Math.cos((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), yc + (y-(Math.sin((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), color[0], color[1], color[2]);
            this.setPixel(context, xc - (x-(Math.cos((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), yc - (y-(Math.sin((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), color[0], color[1], color[2]);
            this.setPixel(context, xc - (y-(Math.sin((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), yc + (x-(Math.cos((Math.PI)/4)*((((2*(Math.sqrt(Math.pow(x,2) + Math.pow(y,2))))*Math.PI)-i)/(2*Math.PI)))), color[0], color[1], color[2]);
